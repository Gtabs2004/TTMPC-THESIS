...
// Read-only oversight view — Manager doesn't post deposits/withdrawals
...
const Manager_Savings_Accounts = () => {
        ...
        <main className="p-8">
          <div className="mb-6">
            <div className="flex items-center justify-between gap-4 mb-4">
              <div>
                <Breadcrumb portal="Manager" page="Savings Accounts" />
                  ...
                  {status === "loading" ? (
                    ...
                    paginated.map((row) => (
                      <tr
                        ...
                        onClick={() =>
                          navigate(`/manager-savings-accounts/${encodeURIComponent(row.account_number)}`)
                        }
                      >
                        ...
                        >
                          <button
                            onClick={() =>
                              navigate(
                                `/manager-savings-accounts/${encodeURIComponent(row.account_number)}`
                              )
                            }
...
export default Manager_Savings_Accounts;
