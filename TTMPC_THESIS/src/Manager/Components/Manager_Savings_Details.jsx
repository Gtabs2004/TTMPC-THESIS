...
// Read-only account detail + ledger — no Deposit/Withdraw actions. Manager
// oversight only; those writes stay Cashier's (initiate) and Bookkeeper's
// (verify) responsibility.
const Manager_Savings_Details = () => {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 min-w-0 flex flex-col h-screen overflow-y-auto">
        ...
        <main className="p-8 overflow-auto">
          <button
            onClick={() => navigate("/manager-savings-accounts")}
...
export default Manager_Savings_Details;
