    ...
    <div className="flex flex-col min-h-screen bg-gray-100 pb-20">
      ...
      <div className="mt-8 bg-white rounded-lg shadow-md overflow-hidden max-w-6xl mx-auto w-full">
        ...
        <div className="p-8 text-sm text-gray-800 leading-relaxed">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            <select className={`${inputStyles} w-32`}><option>Select</option><option>6</option><option>12</option></select>
          ...
          <p className="text-justify text-gray-700 italic text-xs leading-5">
             (TTMPC) in accordance with the terms and conditions as stipulated in the Promissory Note of which I certify to have read and understood clearly. I bind myself to pay out my monthly salary and/or other benefits the required monthly amortization here on or surrender my ATM to TTMPC.
          </p>
        </div>
      </div>
      ...
      <div className="mt-8 bg-white rounded-lg shadow-md overflow-hidden max-w-6xl mx-auto w-full">
        ...
        <div className="p-8 text-sm text-gray-800">
          ...
          <h3 className="font-bold text-gray-900 mb-4">Co-Maker 1</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div><label className={labelStyles}>Name <span className="text-red-500">*</span></label><input type="text" className={inputStyles} /></div>
            <div><label className={labelStyles}>Address <span className="text-red-500">*</span></label><input type="text" className={inputStyles} /></div>
            <div><label className={labelStyles}>Contact No. <span className="text-red-500">*</span></label><input type="text" className={inputStyles} /></div>
            <div className="grid grid-cols-2 gap-4">
                 <div><label className={labelStyles}>Designation <span className="text-red-500">*</span></label><input type="text" className={inputStyles} /></div>
                 <div><label className={labelStyles}>Latest Net Pay <span className="text-red-500">*</span></label><input type="number" className={inputStyles} /></div>
            </div>
          </div>
          ...
          <h3 className="font-bold text-gray-900 mb-4">Co-Maker 2</h3>
