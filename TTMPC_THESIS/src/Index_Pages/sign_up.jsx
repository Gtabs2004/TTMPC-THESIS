...
const Sign_Up = () =>{
  ...
  return (
    <div className="bg-white flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="h-80 bg-gray-100 p-12 mt-5 rounded-xl shadow-md sm:mx-auto sm:w-full sm:max-w-sm">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className="flex w-full justify-center rounded-md bg-green-700 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-green-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-500"
            >
              Sign Up
            </button>
          </div>
