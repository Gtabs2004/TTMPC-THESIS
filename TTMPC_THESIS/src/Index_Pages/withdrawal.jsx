    ...
    <div className="flex flex-col min-h-screen bg-[#F8FAFC]">
        ...
        <main className='flex flex-col items-center flex-grow py-10 px-4'>
            ...
            <div className="w-full max-w-2xl">
              ...
              {/* Titles */}
              <div className='mb-6'>
                <h1 className="text-2xl font-bold text-slate-800 mb-1">Regular Savings Withdrawal</h1>
              ...
              <div className='bg-white p-8 rounded-xl shadow-sm border border-slate-100'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5'>
                  ...
                  {/* Member Name (Read-only styling) */}
                  <div className='flex flex-col sm:col-span-2'>
                    <label className='text-[11px] font-semibold text-slate-500 mb-1.5'>Member Name</label>
                    <input 
                      type="text" 
                  ...
                  {/* Savings Type (Read-only styling) */}
                  <div className='flex flex-col'>
                  ...
                  <div className='flex flex-col'>
                    <label className='text-[11px] font-semibold text-slate-500 mb-1.5'>Current Balance</label>
                    <input 
                      type="text" 
                  ...
                  {/* Withdrawal Amount (Editable) */}
                  <div className='flex flex-col sm:col-span-2 mt-2'>
                    <label className='text-[11px] font-semibold text-slate-800 mb-1.5'>Withdrawal Amount [₱]</label>
                    <input 
                      type="number" 
                      placeholder="0.00"
                  ...
                  {/* Reason for Withdrawal (Editable Textarea) */}
                  <div className='flex flex-col sm:col-span-2'>
                    <label className='text-[11px] font-semibold text-slate-800 mb-1.5'>Reason for Withdrawal [Optional]</label>
                    <textarea 
                      placeholder="e.g. Personal Expenses, Emergency, etc."
                      rows="3"
                      className='bg-white border border-slate-200 text-slate-800 text-sm p-3 rounded-lg w-full resize-none focus:outline-none focus:ring-2 focus:ring-[#66B538] focus:border-transparent transition-all'
                    ></textarea>
                  </div>
                </div>
              </div>
              ...
              <div className='flex flex-col sm:flex-row gap-4 mt-6'>
                <Link to="/withdrawal_success" className='flex-1 flex items-center justify-center gap-2 bg-[#66B538] hover:bg-[#5aa331] text-white font-medium text-sm py-3 px-4 rounded-lg transition-colors cursor-pointer shadow-sm'>
