...
const Cashier_Grocery = () => {
  ...
  const menuItems = [
    ...
    { name: "Payments", icon: CreditCard, path: "/Cashier_Payments" },
    { name: "Disbursement", icon: CreditCard, path: "/Cashier_Disbursement" },
    { 
      name: "Deposits", 
      icon: CreditCard, 
      isDropdown: true,
    ...
    { name: "Withdrawals", icon: CreditCard, path: "/Cashier_Withdrawals" },
